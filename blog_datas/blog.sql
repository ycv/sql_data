...
CREATE TABLE IF NOT EXISTS `blog_article` (
  ...
  `art_tag` varchar(100) NOT NULL COMMENT '关键词',
  `art_description` varchar(255) NOT NULL COMMENT '描述',
  `art_thumb` varchar(255) NOT NULL COMMENT '缩略图',
  `art_content` text NOT NULL COMMENT '内容',
  `art_time` int(11) NOT NULL COMMENT '发布时间',
  `art_editor` varchar(50) NOT NULL COMMENT '作者',
  `art_view` int(11) NOT NULL COMMENT '查看次数',
  `cate_id` int(11) NOT NULL COMMENT '分类id',
  PRIMARY KEY (`art_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='文章' AUTO_INCREMENT=15 ;
--
...
CREATE TABLE IF NOT EXISTS `blog_category` (
  ...
  `cate_view` int(11) NOT NULL COMMENT '查看次数',
  `cate_order` tinyint(4) NOT NULL COMMENT '排序',
  `cate_pid` int(11) NOT NULL COMMENT '父级id',
  PRIMARY KEY (`cate_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='文章分类' AUTO_INCREMENT=13 ;
...
(1, '新闻', '搜集国内外最热门的新闻资讯', '新闻,后盾网', '搜集国内外最热门的新闻资讯，搜集国内外最热门的新闻资讯', 23, 1, 0),
(2, '体育', '发展体育事业，增强国民体质', '体育新闻', '发展体育事业，增强国民体质', 0, 2, 0),
(3, '娱乐', '人人都有自己的娱乐圈', '', '', 0, 3, 0),
(9, '军事新闻', '最新军事新闻_中国军事新闻_国际军事新闻军情网站', '', '', 2, 4, 1),
(8, '热点新闻', '最新新闻事件_热点新闻_热点事件网', '', '', 1, 2, 1),
(10, '体育彩票', '体育彩票管理中心唯一指定官方网站', '', '', 0, 2, 2),
(11, '乐视体育', '最专业的体育赛事平台', '', '', 0, 1, 2),
(12, '腾讯体育', '人气最旺的体育门户', '', '', 0, 3, 2);
...
(1, '网站标题', 'web_title', '后盾Blog系统', 1, '网站大众化标题', 'input', ''),
(2, '统计代码', 'web_count', '百度统计', 3, '网站访问情况统计', 'textarea', ''),
(3, '网站状态', 'web_status', '0', 2, '网站开启状态', 'radio', '1|开启,0|关闭'),
(5, '辅助标题', 'seo_title', '后盾网 人人做后盾', 4, '对网站名称的补充', 'input', ''),
(6, '关键词', 'keywords', '北京php培训,php视频教程,php培训,php基础视频,php实例视频,lamp视频教程', 5, '', 'input', ''),
(7, '描述', 'description', '后盾网顶尖PHP培训，最专业的网站开发php培训，小班化授课，全程实战！业内顶级北京php培训讲师亲自授课，千余课时php独家视频教程免费下载，数百G原创视频资源，实力不容造假！抢座热线：400-682-3231', 6, '', 'textarea', ''),
(8, '版权信息', 'copyright', 'Design by 后盾网 <a href="http://www.houdunwang.com" target="_blank">http://www.houdunwang.com</a>', 7, '', 'textarea', '');
...
CREATE TABLE IF NOT EXISTS `blog_links` (
  ...
  `link_order` int(11) NOT NULL COMMENT '排序',
  PRIMARY KEY (`link_id`)
...
(3, '后盾网', '国内口碑最好的PHP培训机构', 'http://www.houdunwang.com', 2),
(4, '后盾论坛', '后盾网，人人做后盾', 'http://bbs.houdunwang.com', 1),
(5, '快学网', '后盾网旗下在线教育平台', 'http://www.kuaixuewang.com', 3);
...
CREATE TABLE IF NOT EXISTS `blog_migrations` (
  ...
  `batch` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`batch`)
...
CREATE TABLE IF NOT EXISTS `blog_navs` (
  ...
  `nav_alias` varchar(50) NOT NULL COMMENT '别名',
  `nav_url` varchar(255) NOT NULL COMMENT 'url',
  `nav_order` int(11) NOT NULL COMMENT '排序',
  PRIMARY KEY (`nav_id`)
...
(1, '首页', 'Protal', 'http://blog.hd', 1),
(2, '关于我', 'About', 'http://blog.hd/a/14', 2),
(3, '新闻', 'News', 'http://blog.hd/cate/1', 3),
(4, '碎言碎语', 'Doing', 'http://', 4),
(5, '模板分享', 'Share', 'http://', 5),
(6, '学无止境', 'Learn', 'http://', 6),
(7, '留言版', 'Gustbook', 'http://', 7);
...
(1, 'admin', 'eyJpdiI6IlBBNTJjV2ZkWkp3TXZvQm5xdGR3R2c9PSIsInZhbHVlIjoiM3RGYVg3U2pCellJbEdHTlwvS0MzTWc9PSIsIm1hYyI6ImRmYzdjZDhmNGQ2N2I5MTBjOTMxYjdkYmMzNGExZThhZmE2YWMxNGUzYWIzYWM5Mzg4MTQyZDI4OGJkMzJhYTUifQ');
